...
def print_network_info(agent, dashboard_status: str = "disabled"):
    ...
    print(
        ...
        f"+ {RL_CONFIG.action_affordance_features} action affordance "
    ...
    print(f"   Action geometry:  {'ON' if RL_CONFIG.action_context_geometry_bias else 'OFF'} (strength={RL_CONFIG.action_context_geometry_bias_strength}, direct affordances={RL_CONFIG.action_affordance_features})")
